...
const Gamerules = () => {
  return (
    <div className="Div_rules_container">
      <div className="Div_rules_1">
        <div className="rules_Play_1">
